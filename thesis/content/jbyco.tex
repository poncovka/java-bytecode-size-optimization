...
Nástroje pro analýzu bajtkódu jsou umístěné v~balíčku \texttt{jbyco.analyze}. V~rozhraní \texttt{Analyzer} jsou deklarované metody pro zpracování \texttt{class} souborů \texttt{processClassFile} a výpis získaných dat \texttt{writeResults}. Jednotlivé nástroje pro analýzu jsou dostupné podbalíčcích.
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.tree}}
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.instructions}}
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.labels}}
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.operations}}
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.parameters}}
...
\subsubsection{Balíček \texttt{jbyco.analyze.patterns.wildcards}}
