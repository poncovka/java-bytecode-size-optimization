...
%\begin{tpatterns}
%  \code{iload 0; \\ L0; \\ ifeq 0;}
%& \code{lookupswitch \\ \quad L0 X Y \\ \quad L1 \\ \quad L2; \\ IFEQ LABEL(0);}
%& \desc{Dlouh7 nekolika 58dkov7 popis toho, co tam zrovna tak p2kn2 vid9me haloo.} \\
%\end{tpatterns}
...
& \desc{Instrukce pro vkládání číselných proměnných lze někdy nahradit kratšími instrukcemi.} \\
  ...
  \code{ldc 3.0;}
& \code{iconst\_3; \\ i2d;}
& \desc{Drahé instrukce pro vkládání číselným proměnných lze nahradit kratšími instrukcemi pro jiný typ a instrukcemi pro přetypování.} \\

  \code{ldc NaN;}
& \code{dconst\_0; \\ dup2; \\ ddiv;}
& \desc{Instrukci pro vložení konstanty \texttt{NaN} lze nahradit instrukcemi pro operaci $0,0/0,0$. Ušetří se tak jedna položka v tabulce konstant.} \\
