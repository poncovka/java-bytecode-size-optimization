%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Formát instrukčního souboru}\label{Format}
...
\section{Základní struktura}\label{FormatBasic}
...
\section{Konstanty}\label{FormatConstants}
...
\section{Třída}\label{FormatClass}
...
\section{Členské proměnné}\label{FormatFields}
...
\section{Metody}\label{FormatMethod}
...
\pagebreak
\section{Atributy}\label{FormatAttributes}
...
\section{Instrukce}\label{FormatInstruction}
