...
public class RelativeLabelFactory implements AbstractLabelFactory {
	...
	/* (non-Javadoc)
	 * @see jbyco.analyze.patterns.labels.AbstractLabelFactory#init(org.objectweb.asm.Label, org.objectweb.asm.Label)
	 */
	...
	/* (non-Javadoc)
	 * @see jbyco.analyze.patterns.labels.AbstractLabelFactory#getLabel(org.objectweb.asm.Label)
	 */
	@Override
