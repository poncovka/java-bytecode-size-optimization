    ...
    public void visitInsn(int opcode) {
        ...
        switch (opcode) {
            case Opcodes.ACONST_NULL:
                value = parameters.getNull();
                break;
            case Opcodes.ICONST_M1:
                value = parameters.getInt(-1);
                break;
            case Opcodes.ICONST_0:
                value = parameters.getInt(0);
                break;
            case Opcodes.ICONST_1:
                value = parameters.getInt(1);
                break;
            case Opcodes.ICONST_2:
                value = parameters.getInt(2);
                break;
            case Opcodes.ICONST_3:
                value = parameters.getInt(3);
                break;
            case Opcodes.ICONST_4:
                value = parameters.getInt(4);
                break;
            case Opcodes.ICONST_5:
                value = parameters.getInt(5);
                break;
            case Opcodes.LCONST_0:
                value = parameters.getLong(0);
                break;
            case Opcodes.LCONST_1:
                value = parameters.getLong(1);
                break;
            case Opcodes.FCONST_0:
                value = parameters.getFloat(0);
                break;
            case Opcodes.FCONST_1:
                value = parameters.getFloat(1);
                break;
            case Opcodes.FCONST_2:
                value = parameters.getFloat(2);
                break;
            case Opcodes.DCONST_0:
                value = parameters.getDouble(0);
                break;
            case Opcodes.DCONST_1:
                value = parameters.getDouble(1);
                break;
        }
        ...
        if (opcode == Opcodes.NEWARRAY) {
            ...
            switch (operand) {
                ...
                case Opcodes.T_SHORT:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Unknown type of the array.");
            }
