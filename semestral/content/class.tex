...
% aconst_null, bipush, sipush, iconst_m1, iconst_n, lconst_n, fconst_n, dconst_n, ldc, ldc_w, ldc2_w

Vložení hodnoty z tabulky konstant na operační zásobník lze docílit instrukcí \texttt{lcd} $index$, kde $index$ je index to tabulky konstant na číselnou nebo řetězcovou konstantu, třídu nebo metodu.  
...
Instrukce \texttt{iinc} $index$ $value$ inkrementuje lokální proměnnou danou indexem do polem lokálních proměnných o hodnotu $value$. 



\begin{figure} [h!]
  \begin{tabular}{l l l l l }
  $\langle n \rangle$\texttt{add} & $\dots, a, b$ & $\dots, a+b$ & & $\langle n \rangle \in \{\texttt{i},\texttt{f}, \texttt{l}, \texttt{d} \}$ \\ 
...
% <n>add          ...,a,b          ...,a+b              		  a,b jsou hodnoty daného typu, n in {i,f,d,...}
% <n>aload        ...,array, i     ...,array[i]		                  array je reference na pole, i je typu int
% <n>astore       ...,array, i, v  ...              array[i] = v
